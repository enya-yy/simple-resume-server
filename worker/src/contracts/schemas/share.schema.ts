...
export type VerifySharePasswordBody = z.infer<typeof verifySharePasswordBodySchema>;

export const verifySharePasswordResponseSchema = z.object({
  verified: z.literal(true),
});

export type VerifySharePasswordResponse = z.infer<typeof verifySharePasswordResponseSchema>;
